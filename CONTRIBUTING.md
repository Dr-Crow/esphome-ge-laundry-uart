...
- Keep editable KiCad files in `design/`, orderable outputs in `manufacturing/`, technical inspection evidence in `validation/`, and documentation photographs or renders in `images/`.
...
5. Clearly distinguish automated checks from vendor preview, electrical bring-up, appliance testing, and enclosure fit tests.
